...
See `docs/beta-readiness.md`, `docs/market-data-foundation.md`, `docs/jarvis-openai-provider.md` and `.env.example` for setup, Closed Beta access, health checks, deployment and data-honesty rules.
